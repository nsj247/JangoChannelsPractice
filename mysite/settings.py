...
SECRET_KEY = 'django-insecure-w95^_f7za9zg%#$1ari_m0mh@h_i4r6yldg!rcwp*@!w28iy7z'
                ...
                "hosts": [
                    {
                        ...
                        "port": channel_layer_redis["PORT"] or 13244,
